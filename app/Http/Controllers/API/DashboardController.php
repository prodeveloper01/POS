...
class DashboardController extends Controller
{
    ...
    public function getTodaySummery()
    {
        ...
        return [
            ...
            'salesAmount' => Invoice::where('status', 1)->whereDate('invoice_date', $date)->get()->sum('calculated_total'),
    ...
    public function getThisMonthSummery()
    {
        ...
        return [
            ...
            'salesAmount' => Invoice::where('status', 1)->whereMonth('invoice_date', '=', date('m'))->whereYear('invoice_date', date('Y'))->get()->sum('calculated_total'),
    ...
    public function getThisYearSummery()
    {
        ...
        return [
            ...
            'salesAmount' => Invoice::where('status', 1)->whereYear('invoice_date', date('Y'))->sum('sub_total'),
