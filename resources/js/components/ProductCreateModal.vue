<template>
  <div>
    <div class="pl-1">
      <a
        class="create-button"
        @click="showProductCreateModal = !showProductCreateModal"
      >
        <i class="fas fa-solid fa-plus-circle"></i>
      </a>
    </div>
    <ModalMini v-show="showProductCreateModal">
        ...
        >
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-12">
                <label for="barcodeSymbology"
                  >{{ $t("products.list.common.barcode_symbology") }}
                  <span class="required">*</span></label
                >
                <select
                  id="barcodeSymbology"
              ...
              <div v-if="items" class="form-group col-12">
              ...
              <div v-if="brands" class="form-group col-12">
              ...
              <div v-if="units" class="form-group col-12">
                <label for="itemUnit"
                  >{{ $t("common.unit") }}
                  <span class="required">*</span></label
                >
              ...
              <div v-if="taxes" class="form-group col-12">
                <label for="productTax"
                  >{{ $t("products.list.common.product_tax") }}
                  <span class="required">*</span></label
                >
                <v-select
                  ...
                  :options="taxes"
                  label="code"
                  :class="{ 'is-invalid': form.errors.has('productTax') }"
                  name="productTax"
                  :placeholder="$t('products.list.common.tax_placeholder')"
              ...
              <div class="form-group col-12">
                <label for="taxType"
                  >{{ $t("products.list.common.tax_type") }}
                  <span class="required">*</span></label
                >
                <select
                  id="taxType"
                  ...
                  class="form-control"
                  :class="{ 'is-invalid': form.errors.has('taxType') }"
          ...
          <div class="card-footer d-flex justify-content-between px-5">
            ...
            <button
              ...
              @click="showProductCreateModal = false"
            >
              {{ $t("Cancel") }}
            </button>
          </div>
