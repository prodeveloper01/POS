    ...
    <!-- <div class="mb-4">
      <div class="custom-control custom-checkbox">
        <input
          ...
          @click="rtlHandler"
        />
        <label for="rtl-modee" class="custom-control-label">{{
          $t('RTL mode')
        }}</label>
      </div>
    </div> -->
    ...
    <div>
      ...
      <div class="custom-control custom-checkbox mb-1">
        <input
          ...
          value="1"
          :checked="isNavFixed ? true : false"
          @click="addBodyClass('isNavFixed', 'layout-navbar-fixed')"
        />
      ...
      <div class="custom-control custom-checkbox mb-4">
        <input
          ...
          id="border-bottom-0"
          value="1"
          :checked="isBorderBtm ? true : false"
          @click="addBodyClass('isBorderBtm', 'border-bottom-0')"
        />
    ...
    <div>
      ...
      <div class="custom-control custom-checkbox mb-1">
        <input
          ...
          id="sidebar-dark"
          value="1"
          :checked="isSidebarDark ? true : false"
          @click="addSidebarClass('isSidebarDark', 'dark-sidebar')"
        />
      ...
      <div class="custom-control custom-checkbox mb-1">
        <input
          ...
          id="layout-fixed"
          value="1"
          :checked="isLayoutFixed ? true : false"
          @click="addBodyClass('isLayoutFixed', 'layout-fixed')"
        />
      ...
      <div class="custom-control custom-checkbox mb-1">
        <input
          ...
          id="sidebar-mini"
          value="1"
          :checked="isSidebarMini ? true : false"
          @click="addBodyClass('isSidebarMini', 'sidebar-mini')"
        />
      ...
      <div class="custom-control custom-checkbox mb-1">
        <input
          ...
          id="nav-legacy"
          value="1"
          :checked="isNavLegacy ? true : false"
          @click="addNavSidebarClass('isNavLegacy', 'nav-legacy')"
        />
