            ...
            <div class="row">
              ...
              <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
                <div class="btn-group c-w-100">
                  ...
                  <a href="/clients/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
                  ...
                  <tr v-show="items.length" v-for="(data, i) in items" :key="i">
                    ...
                    " class="text-right no-print">
                      <div class="btn-group">
                        ...
                        <a v-if="appInfo.defaultClientSlug != data.slug && $can('client-delete')"
      ...
      <form slot="body" role="form" @submit.prevent="saveCsv" @keydown="form.onKeydown($event)">
        <div class="w-100">
          ...
          <div class="row mt-3">
            ...
            <button type="reset" class="btn btn-secondary ml-2" @click="form.reset()">{{ $t('common.reset') }}
            </button>
          </div>
        </div>
      </form>
...
export default {
  ...
  methods: {
    saveCsv() {
      this.form.post('/api/client-import').then((response) => {
    ...
    async submitCsvFile() {
      ...
      */
      await axios.post('/api/client-import',
        formData,
        {
          headers: {
