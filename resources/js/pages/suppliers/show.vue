        ...
        " class="card">
              ...
              <div class="col-md-8">
                <ul class="nav nav-pills">
                  <li v-if="$can('purchase-list')" class="nav-item">
                    <a class="nav-link active" href="#purchases" data-toggle="tab">{{ $t("common.purchases") }}
                      <span v-if="pagination" class="badge badge-dark">{{
                          pagination.total
                      }}</span></a>
                  </li>
                  <li v-if="$can('purchase-return-list')" class="nav-item">
                    <a @click="getSupplierReturns" class="nav-link" href="#returns" data-toggle="tab">{{
                  ...
                  <li v-if="$can('purchase-payment-list')" class="nav-item">
                    <a @click="getSupplierPayments" class="nav-link" href="#payments" data-toggle="tab">{{
                  ...
                  <li v-if="$can('non-purchase-payment-list')" class="nav-item">
                    <a @click="getNonPurchaseTransactions" class="nav-link" href="#transactions" data-toggle="tab">{{
          ...
          <div class="card-body">
            <div class="tab-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('purchases')" href="#" v-tooltip="'Refresh'" class="btn btn-success">
              ...
              <!-- purchase-returns -->
              <div v-if="$can('purchase-return-list')" class="tab-pane" id="returns">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-2">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('purchase-returns')" href="#" v-tooltip="'Refresh'"
                  ...
                  <!-- NEW PAGINATION -->
                  <div v-if="returnPagination && returnPagination.total > 0" class="dtable-footer">
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
              ...
              <!-- purchase-payments -->
              <div v-if="$can('purchase-payment-list')" class="tab-pane" id="payments">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-2">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('purchase-payments')" href="#" v-tooltip="'Refresh'"
                            class="btn btn-success">
                            <i class="fas fa-sync"></i>
                          </a>
                        </div>
...
" :offset="5" class="justify-flex-end" @paginate="paymentsPaginate" />
              ...
              <div v-if="$can('non-purchase-payment-list')" class="tab-pane" id="transactions">
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-2">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('non-purchase-transactions')" href="#" v-tooltip="'Refresh'"
                            class="btn btn-success">
                            <i class="fas fa-sync"></i>
                          </a>
                        </div>
