...
<head>
  ...
  <script type="text/javascript">
    window.$crisp=[];window.CRISP_WEBSITE_ID="ee891f0f-3dd8-4bcb-bb49-948a93ad1fa8";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();
  </script>
          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
              <ul id="nav" class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                  <a href="https://codeshaper.net/contact-us" target="_blank" aria-label="Toggle navigation">Support</a>
                </li>
              </ul>
            </div> <!-- navbar collapse -->
        ...
        <div class="hero-content">
          ...
          <ul class="header-features">
            ...
            <li class="wow fadeInLeft" data-wow-delay=".7s">
              <a href="#">Fully Responsive & Easy To use</a>
            </li>
            <li class="wow fadeInLeft" data-wow-delay=".8s">
              <a href="#">Dark Version & Dashboard Customization</a>
            </li>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
          ...
          <h3>Expense</h3>
          <p>The Expense module allows you to manage your company expenses. You can categorize and subcategorize all of your expenses. All expenses are connected with accounts so never allow another expense to go unaccounted.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
          ...
          <h3>Purchase</h3>
          <p>The Purchase module allows you to manage product purchases and returns. By creating purchases the stock quantity of products will be increased and by deleting purchases the stock quantity of products will be decreased.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
          ...
          <h3>Sales</h3>
          <p>The Sales module allows you to manage sales quotations, product sales, and returns. By creating sales the stock quantity of products will be decreased and by deleting sales the stock quantity of products will be increased.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
          ...
          <h3>Accounting</h3>
          <p>The Accounting module allows you to manage transactions and accounts. Every transaction is connected to cash or bank accounts. A credit transaction will increase the balance and a debit transaction will decrease the balance.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
          ...
          <h3>Loan</h3>
          <p>The Loan module helps you to manage loan authorities, loans, and loan payments. Acculance allows you to create both CC loans & Term loans. The amount will be added to account and can be used for transactions.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
          ...
          <h3>Asset</h3>
          <p>The Asset module helps you manage your company assets and their deprecation. We have implemented a straight-line depreciation method to calculate the deprecation. You can also create assets without any deprecation.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
          ...
          <h3>Payroll</h3>
          <p>The Payroll module helps you manage  monthly salaries. Using the payroll module you can generate monthly salaries for  employees. Payrolls are connected with accounts so never allow another payroll to go unaccounted.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
          ...
          <h3>Inventory</h3>
          <p>The Inventory module helps you keep track of your product stocks and adjust stock by increasing or decreasing stock. It helps to see the avg. purchase price including inventory history(Stock In & Stock Outs) from this module.</p>
        </div>
        <!-- End Single Feature -->
      </div>
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
          ...
          <h3>Reports</h3>
          <p>Reports are very important to every business. Acculance provides various reports to track your business performance. You can easily check the balance sheet, summary report, profit/loss report, expense report, and inventory report.</p>
        </div>
        <!-- End Single Feature -->
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
        <div class="title">
          ...
          <p>Acculance Packed With Tons of Useful Hidden Features , Some are Listed below.</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          ...
          <p class="wow fadeInUp" data-wow-delay=".6s">We are offering two types of license for our software such as Regular license and Extended license</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-table wow fadeInUp" data-wow-delay=".2s">
          ...
          <div class="table-head">
            ...
            <div class="price">
              <h2 class="amount">$39</h2>
            </div>
            <div class="button">
              <a href="https://codecanyon.net/item/acculance-ultimate-sales-inventory-accounting-management-system/37545480" class="btn">Buy Regular License</a>
            </div>
          </div>
          <!-- End Table Head -->
          <!-- Start Table Content -->
          <div class="table-content">
            ...
            <ul class="table-list">
              ...
              <li><i class="lni lni-checkmark-circle"></i> 6 Month support <a href="https://codecanyon.net/page/item_support_policy?_ga=2.184920874.260634607.1652244325-1968967188.1652244325" traget="__blank">(Please check here what included in support)</a></li>
              ...
              <li><i class="lni lni-cross-circle" style="color: red;"></i> Anydesk/Teamviewer Support</li>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-table wow fadeInUp" data-wow-delay=".4s">
          ...
          <div class="table-head">
            ...
            <p>All the basics for your business. Permitted for multiple domains for commercial use only.</p>
            <div class="price">
              <h2 class="amount">$499</h2>
            </div>
            <div class="button">
              <a href="https://codecanyon.net/item/acculance-ultimate-sales-inventory-accounting-management-system/37545480" class="btn">Extended License</a>
            </div>
          </div>
          <!-- End Table Head -->
          <!-- Start Table Content -->
          <div class="table-content">
            ...
            <ul class="table-list">
              ...
              <li><i class="lni lni-checkmark-circle"></i> Life time update.</li>
              <li><i class="lni lni-checkmark-circle"></i> 6 Month support <a href="https://codecanyon.net/page/item_support_policy?_ga=2.184920874.260634607.1652244325-1968967188.1652244325" traget="__blank">(Please check here what included in support)</a></li>
              <li><i class="lni lni-checkmark-circle"></i> For multiple domains for commercial uses.</li>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        ...
        <div class="single-table wow fadeInUp" data-wow-delay=".6s">
          ...
          <div class="table-head">
            ...
            <p>We will be happy if we can assist you with any of your custom work. We love hearing from you! Feel free to leave us a message. Use the contact form to get in touch with us. We'll reply back within the next 24 hour.</p>
            <div class="button mt-5">
              <a href="https://codeshaper.net/contact-us" target="_blank" class="btn">Contact Us</a>
            </div>
          </div>
          <!-- End Table Head -->
          <!-- Start Table Content -->
    ...
    <div class="row">
      <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
        <div class="cta-content">
          <h2 class="wow fadeInUp" data-wow-delay=".2s">View live demo to explore all the amazing features of Acculance
          </h2>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 text-center col-12">
          ...
          <div class="single-footer f-about">
            <div class="logo">
              <a href="{{ url('/') }}">
                <img src="{{ asset('landing-assets/images/logo/white-logo.svg') }}" alt="#">
              </a>
            </div>
            <p>Ultimate Sales, Inventory, Accounting Management System</p>
            <ul class="social">
              <li><a href="https://codeshaper.net" target="_blank"><i class="lni lni-website"></i></a></li>
              <li><a href="https://www.facebook.com/Codeshaperbd" target="_blank"><i class="lni lni-facebook-filled"></i></a></li>
              <li><a href="https://twitter.com/codeshaperbd" target="_blank"><i class="lni lni-twitter-original"></i></a></li>
              <li><a href="https://www.instagram.com/codeshaper_int/" target="_blank"><i class="lni lni-instagram"></i></a></li>
              <li><a href="https://www.linkedin.com/in/code-shaper-7b8a0513b" target="_blank"><i class="lni lni-linkedin-original"></i></a></li>
              <li><a href="https://www.pinterest.com/codeshaperbd/" target="_blank"><i class="lni lni-pinterest"></i></a></li>
            </ul>
            <p class="copyright-text">Copyright &copy; By <a href="https://codeshaper.net/" rel="nofollow" target="_blank">Codeshaper</a>
            </p>
          </div>
          <!-- End Single Widget -->
        </div>
